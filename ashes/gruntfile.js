...
module.exports = function (grunt) {
	...
	grunt.initConfig({
        ...
        uglify: {  
            project: {
				...
				files: {
                    ...
                    '<%= dist.path %>/js/mchp.min.js': jsfiles,
                    '<%= dist.path %>/js/pressRelease.min.js': 'assets/src/project/js/widgets/pressRelease/pressRelease.js',
                    '<%= dist.path %>/js/tracking.min.js': 'assets/src/project/js/tracking.js'
				}
            },
            project_reg: {
                options: {
		...
		watch: {
			...
			js: {
				files: ['<%= src.path %>/**/*.js'],
                tasks: ['uglify:project', 'uglify:project_reg']
			},
		},
